		...
		<div class="modal-dialog modal-dialog-centered modal-lg">
			<div class="modal-content">
				...
				<div class="modal-footer mx-auto" >
					<button type="button" class="btn px-5 endBtn" id="btn-delete-review" onclick="location.href='https://localhost/user/sentReview';">아니요</button>
					<button type="button" class="btn px-5 endBtn" id="btn-close" onclick="location.href='https://localhost/review/delete';">네</button>
		    	</button>
				</div>
			</div>
		</div>
