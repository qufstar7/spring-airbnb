					...
					<div class="col-4">
		     		...
		     		<div class="col-8">		
		     			<div class="row">
		     				<div class="col-12">
		      					<div class="mt-3 mb-5">
					      			<h3 class="mb-3 "><strong>Danny님에 대한 후기를 쓰세요.</strong></h3>
					      			<p>14일 동안 후기를 작성할 수 있습니다. 후기 작성 기간 동안에는 호스트도 회원님에 대한 후기를 작성해야 회원님의 피드백을 읽을 수 있습니다. 
		     			...
		     			<div class="row">
		     				<div class="col-12">
						       	<h3 class="mb-5"><strong>숙박이 어땠나요?</strong></h3>
							 	<form class="mb-3" name="reviewScore" id="review-score" method="post" action="form2">
									<div class="row mb-5">
										<div class="col-12">
											<h3 class="fs-4" id="total-score"><strong>전체적 만족도</strong></h3>
											<div id="box-total">
									...
									<div class="row mb-5">
										<div class="col-12">
											<h3 class="fs-4" id="clean-score"><strong>청결도</strong></h3>
											<p class="question">숙소는 회원님이 예상한 것만큼 깨끗한가요?</p>
											<div id="box-clean">
												<i class="bi bi-star fs-2" data-score="1"></i>
												<i class="bi bi-star fs-2" data-score="2"></i>
												<i class="bi bi-star fs-2" data-score="3"></i>
									...
									<div class="row mb-5">
										<div class="col-12">
											<h3 class="fs-4" id="accuracy-score"><strong>정확성</strong></h3>
											<p class="question">숙소 사진과 설명이 실제 숙소와 얼마나 일치하나요?</p>
											<div id="box-accuracy">
												<i class="bi bi-star fs-2" data-score="1"></i>
												<i class="bi bi-star fs-2" data-score="2"></i>
												<i class="bi bi-star fs-2" data-score="3"></i>
									...
									<div class="row mb-5">
										<div class="col-12">
											<h3 class="fs-4" id="communication-score"><strong>커뮤니케이션</strong></h3>
											<p class="question">숙박기간 전, 혹은 도중에 호스트와 연락이 잘 되고, 문의한 사항에 대하여 호스트가 빨리 응답해 왔습니까?</p>
									...
									<div class="row mb-5">
										<div class="col-12">
											<h3 class="fs-4" id="location-score"><strong>위치</strong></h3>
											<p class="question">숙소 지역은 만족하셨나요? 안전성과 편리성을 고려해 주세요.</p>
											<div id="box-location">
												<i class="bi bi-star fs-2" data-score="1"></i>
												<i class="bi bi-star fs-2" data-score="2"></i>
												<i class="bi bi-star fs-2" data-score="3"></i>
									...
									<div class="row mb-5">
										<div class="col-12">
											<h3 class="fs-4" id="checkin-score"><strong>체크인</strong></h3>
											<p class="question">호스트는 회원님의 원활한 체크인 절차를 위해 최선을 다했나요?</p>
											<div id="box-checkin">
												<i class="bi bi-star fs-2" data-score="1"></i>
												<i class="bi bi-star fs-2" data-score="2"></i>
												<i class="bi bi-star fs-2" data-score="3"></i>
									...
									<div class="row mb-5">
										<div class="col-12">
											<h3 class="fs-4" id="convenience-score"><strong>편의시설</strong></h3>
											<p class="question">호스트가 숙소 설명에 약속된 모든 것을 제공하였나요?</p>
									...
									<div class="row mb-5">
										<div class="col-12">
											<h3 class="fs-4" id="value-score"><strong>가치</strong></h3>
											<p class="question">이 숙소를 평가하자면?</p>
											<div id="box-value">
												<i class="bi bi-star fs-2" data-score="1"></i>
												<i class="bi bi-star fs-2" data-score="2"></i>
												<i class="bi bi-star fs-2" data-score="3"></i>
									...
									<div>
										<button type="submit" class="btn px-5" id="review-next">다음</button>
									</div>
								</div>
							</div>
			      		</div>
