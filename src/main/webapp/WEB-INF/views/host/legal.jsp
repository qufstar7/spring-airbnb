	...
	<div class="host-box">
		...
		<div id="left-div">
			...
			<div class="align-self-center m-5">
				<div role="text" class="left-main-text">마지막으로 몇 가지 질문에 답해주세요.</div>
			</div>
		</div>
				...
				<div class="container-fluid">
					...
					<div class="">
						<button id="next-btn" class="float-start btn btn-dark float-end"
							type="submit" onclick="location.href='/host/complete'" style="width: 80px; height: 48px;">
							다음</a>
					</div>
				</div>
			</footer>
