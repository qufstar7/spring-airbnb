		...
		<div id="right-div">
			...
			<div class="main-box align-self-center bg-white p-4">
				<div class="main-middle-box">
					...
					<textarea rows="3" id="textBox" class="textArea" name="description" maxlength="200" autocomplete="off" placeholder="숙소에 대한 설명을 작성해주세요." style="font-size:24px; overflow-y: scroll !important;resize: none;">${REGISTER_ACC.description }</textarea>
				    <div class="fs-5 fw-light mt-2">
						<p class="d-inline textCount">0</p>
					    <p class="d-inline">/</p>
					    <p class="d-inline">1000</p>
				    </div>
				</div>
			</div>
		    </form>
				...
				<div class="container-fluid">
					...
					<div class="">
						<button id="back-btn"
							...
							type="button" onclick="location.href='/host/tags'"
