	...
	<div class="host-box">
		...
		<div id="right-div">
			...
			<div class="main-box align-self-center bg-white"
				...
				<!-- 구글지도배경 -->
				<div id="bgMap" style="width: 100%; height: 1100px; z-index: 0;"></div>
			</div>
			...
			<div
				...
				<div class="location-form-scroll position-relative mt-3">
					...
					<div class="border-top mt-4 pt-4" style="padding-bottom:50px;">
						...
						<!-- 구체적인 지도 -->
						<div class="mapSmallBox mt-3 position-absolute" style="width:100%; max-width:550px; height:280px; overflow:hidden;">
...
$(function() {
	...
	$("#check-btn").on("click", function() {
		...
		*/
	    ...
	    message += '북동쪽 좌표는 ' + neLatLng.getLat() + ', ' + neLatLng.getLng() + ' 입니다';
	    console.log(message);
	    console.log('위도는 ' + center.getLat() + "경도는 " + center.getLng());
