	...
	<div class="host-box">
		...
		<div id="left-div">
			...
			<div class="align-self-center m-5">
				<div role="text" class="left-main-text">호스팅할 숙소 유형을 알려주세요 host/types</div>
			</div>
		</div>
			...
			<div class="main-box align-self-center bg-white">
				<form id="form-select-type">
					...
					<div id="box-buttons" class="bd-highlight">
						...
						<input class="hiddenField1" type="hidden" name="type1" value="0">
						<input class="hiddenField2" type="hidden" name="type2" value="0">
						<input class="hiddenField3" type="hidden" name="type3" value="0">
					</div>
				</form>
			</div>
...
$(function(){
	...
	$("#right-content-box").on("click", '.btn-maintypes', function() {
		...
		// 히든필드 생성 및 추가
		let hiddenField1 = '<input class="hiddenField1" type="hidden" name="type1" value="' + Number(type1) + '">';
	...
	$("#right-content-box").on("click", '.btn-subtypes', function() {
		...
		// 히든필드 생성 및 추가
		let hiddenField2 = '<input class="hiddenField2" type="hidden" name="type2" value="' + Number(type2) + '">';
	...
	$("#right-content-box").on("click", '.btn-privacytypes', function() {
		...
		// 히든필드 생성 및 추가
		let hiddenField3 = '<input class="hiddenField3" type="hidden" name="type3" value="' + Number(type3) + '">';
