		...
		<div id="right-div">
			...
			<footer class="footer mt-auto py-3 bg-light">
				<div class="container-fluid">
					...
					<!-- 뒤로/다음버튼 -->
					<div class="">
						<button id="back-btn" class="float-start btn btn-none ms-4 fs-6 text-decoration-underline text-black border-0" type="button" onclick="location.href='/host/price'" style="padding-top: 14px">뒤로</button>
					</div>
					<div class="">
