				...
				<div class="main-middle-box m-auto" style="height:100%;">
					<div class="plusMiusBox float-end" id="guestBtnBox">
						...
						<div class="mx-3" id="priceInputBox">
							<input id="priceInput" type="number" min="0" max="50000000" placeholder="₩00" autocomplete="off" name="price" value="${REGISTER_ACC.price }" aria-invalid="true">
						</div>
				...
				<div class="container-fluid">
					...
					<div class="">
						<button id="back-btn"
							...
							type="button" onclick="location.href='/host/description'"
