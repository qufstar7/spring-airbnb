...
<body>
	...
	<a id="logo-link" href="/"> <svg viewBox="0 0 32 32"
			xmlns="http://www.w3.org/2000/svg" aria-label="에어비앤비 홈페이지" role="img"
			focusable="false">
			<path
	...
	<div class="host-box">
		...
		<div id="right-div">
			...
			<div class="mapBox position-relative">
				...
				<!-- rightDiv header nav -->
				<div id="locationRightDivHeader" class="right-div-header"
					style="z-index: 2; background-color: transparent !important;">
							...
							<div id="navbarNav">
								<ul class="navbar-nav">
									<li class="nav-item nav-ask-superhost"><a
										id="locationProfileBtn"
										class="profile-btn right-nav-btn nav-link active rounded-pill"
										href="">
											<div id="locationProfileImgBox">
												<img id="locationProfileImg"
													class="sm-profile-img front-img"
													src="/resources/images/host/julian-wan.jpg"
													aria-hidden="true"> <img id="locationProfileImg"
													...
													aria-hidden="true">
											</div> <span id="locationProfileText" class="profile-text">${LOGIN_USER.name }님의 숙소
												등록하기</span>
									</a></li>
									<li class="nav-item"><a
				...
				<div class="container-fluid">
					...
					<div class="">
						<button id="back-btn"
							...
							type="button" onclick="history.go(-1)" style="padding-top: 14px">뒤로</button>
					</div>
					<div class="">
						<button id="next-btn" class="float-start btn btn-dark float-end"
							type="submit" onclick="location.href='/host/locationDetail'"
