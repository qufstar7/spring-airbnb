...
<div class="container my-3">
	...
	<!-- 오른쪽 -->
	<div class='right-box'>
		<div class="row mb-3 my-5 px-3" style= "margin:10px;padding:10px" >
			<div class ="border bg-white rounded">
				<div class="card mb-3 my-3 border-white" style="max-width: 540px;">
				  <div class="row g-0">
				    <div class="col-md-4">
						<img alt="숙소사진" style=" width:200px; height:150px;" class="img-fluid rounded" src="../resources/images/acc/sample-home.jpg" >
				    </div>
				    <div class="col-md-8">
				      <div class="card-body">
				        <p class="card-title"><small class="text-muted">캠핑카</small></p>
				        <p class="card-text">숙소 이름</p>
				        <p class="card-text"><small class="text-muted">★$4.75(후기 $106개)</small></p>
				      </div>
				    </div>
				  </div>
				</div>
